## This code is authored by Shan Sun and is found here: https://github.com/ssun6/plotmicrobiome/blob/main/R/p_compare.R

#input: pvalues from prior step (statistical test step) for two datasets; default method is Spearman
#output: p-value vs p-value plots for a given pair of p-values
